...
//      destination.position_ = varint_decode(input_it, end_it);
//
//      destination.id_.resize(varint_decode(input_it, end_it));
//      if (destination.id_.size())
//        is.read(&destination.id_[0], destination.alt_.size());
//
//      destination.ref_.resize(varint_decode(input_it, end_it));
//      if (destination.ref_.size())
//        is.read(&destination.ref_[0], destination.ref_.size());
//
//      destination.alt_.resize(varint_decode(input_it, end_it));
//      if (destination.alt_.size())
//        is.read(&destination.alt_[0], destination.alt_.size());
//
//      std::uint64_t offset = 0;
//      destination.non_zero_haplotypes_.reserve(varint_decode(input_it, end_it));
